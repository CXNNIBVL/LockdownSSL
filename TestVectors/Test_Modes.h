...
namespace LockdownSSL
{
	namespace Test
	{
		...
		void ctr_aes128_test()
		{
			...
			auto instance = LockdownSSL::Cipher::Aes::getInstance_128(key);
			auto ctrInstance_1 = LockdownSSL::EncryptionModes::CTR(instance, Nonce);

			ctrInstance_1 << plaintext;
			auto encrypted = ctrInstance_1.getOutput();
			...
			auto ctrInstance_2 = LockdownSSL::EncryptionModes::CTR(instance, Nonce);

			ctrInstance_2 << ciphertext;
			auto decrypted = ctrInstance_2.getOutput();
